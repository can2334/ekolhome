    ...
    return (
        <div className="fixed bottom-6 right-6 z-[999] font-sans">
                    ...
                    >
                        ...
                        <div className="bg-[#075E54] p-4 text-white flex justify-between items-center">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="font-semibold text-sm">EkolHome Destek</p>
                                    <p className="text-[10px] text-white/80">Çevrimiçi</p>
                                </div>
                            </div>
                        ...
                        <div className="h-[300px] bg-[#E5DDD5] p-4 overflow-y-auto flex flex-col gap-2"
                            ...
                            <div className="bg-white p-3 rounded-lg rounded-tl-none shadow-sm max-w-[80%] self-start">
                                <p className="text-[10px] text-green-600 font-bold mb-1 font-sans">Murat</p>
                                <p className="text-xs text-gray-800">Sizin için buradayız! Size nasıl yardımcı olabilirim?</p>
                        ...
                        <div className="p-3 bg-white flex items-center gap-2">
                            ...
                            <button
                                ...
                                className="bg-[#25D366] text-white p-2 rounded-full hover:bg-[#128C7E] transition-all active:scale-95"
                            >
                                <Send size={18} />
                            </button>
                        </div>
            ...
            >
                ...
                <div className="bg-[#25D366] p-4 rounded-full shadow-2xl hover:scale-110 transition-transform active:scale-90">
